...
const isComplete = computed(() => answeredCount.value === 9);
...
const severity = computed(() => {
  ...
  if (!isComplete.value)
    return {
      level: "填寫中",
      color: "filling",
      advice: `已完成 ${answeredCount.value}/9 題`,
    };
  if (s <= 13)
    return {
      level: "正常範圍",
  ...
  <div class="rsi">
    ...
    <div class="rsi-header">
      ...
      <div class="score-badge" :class="severity.color">
        ...
        <span class="score-label">{{
          isComplete ? severity.level : `${answeredCount}/9`
        }}</span>
      </div>
    </div>
    ...
    <div class="severity-bar-wrap">
      <div class="severity-bar">
        <div
          ...
          :style="{ width: Math.min((totalScore / 45) * 100, 100) + '%' }"
        />
      </div>
    ...
    <div class="rsi-group">
      <div class="group-header">
        ...
        <div class="group-score-pill">{{ answeredCount }}/9 題</div>
      </div>
          ...
          <div class="option-row">
            <label
              ...
              :class="{
                ...
                high: opt.value >= 4 && selections[q.key] === opt.value,
                ['s' + opt.value]: true,
              }"
            >
              <input
    ...
    <!-- Result card -->
    <div class="rsi-result" :class="severity.color">
    ...
    <div v-if="showResults" class="results-detail">
      ...
      <div class="detail-row total-row">
        ...
        <span class="detail-score brand">{{ totalScore }} / 45</span>
    ...
    <p v-if="!isComplete" class="progress-hint">
      已完成 {{ answeredCount }}/9 題，尚餘 {{ 9 - answeredCount }} 題
    </p>
  </div>
</template>
