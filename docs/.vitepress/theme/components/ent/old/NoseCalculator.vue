...
// NOSE score = raw × 5
const noseScore = computed(() => rawScore.value * 5);
...
const severity = computed(() => {
  ...
  if (!isComplete.value)
    return {
      level: "填寫中",
      color: "filling",
      advice: `已完成 ${answeredCount.value}/5 題`,
    };
  if (s === 0)
  ...
  <div class="nose">
    ...
    <div class="nose-header">
      ...
      <div class="score-badge" :class="severity.color">
        <span class="score-number">{{ isComplete ? noseScore : "—" }}</span>
        <span class="score-label">{{
          isComplete ? severity.level : `${answeredCount}/5`
        }}</span>
      </div>
    </div>
    ...
    <div class="nose-group">
      <div class="group-header">
        ...
        <div class="group-score-pill">{{ answeredCount }}/5 題</div>
      </div>
      ...
      <div class="item-list">
        ...
        >
          ...
          <!-- Score options — horizontal 5-option row -->
    ...
    <!-- Result card -->
    <div class="nose-result" :class="severity.color">
      <div class="result-left">
        <span class="result-number">{{ isComplete ? noseScore : "—" }}</span>
    ...
    <div v-if="showResults" class="results-detail">
      ...
      <div class="detail-row total-row">
        ...
        <span class="detail-score brand">{{ rawScore }} / 20</span>
    ...
    <p v-if="!isComplete" class="progress-hint">
      已完成 {{ answeredCount }}/5 題，尚餘 {{ 5 - answeredCount }} 題
    </p>
  </div>
</template>
