  ...
  <div class="lipid">
    ...
    <div class="result-card" v-if="effectiveCat">
      <div class="rc-table">
        ...
        <div class="rc-row">
          <span class="rc-col-label" :style="{ color: catColors[effectiveCat] }"
            >LDL-C</span
          >
      ...
      <div class="rc-meds" v-if="statinRecommendation || tgRecommendation">
        ...
        <div class="meds-block" v-if="tgRecommendation">
          ...
          <template v-else-if="tgRecommendation.type === 'lifestyle'">
            ...
            <ul class="meds-list">
              <li v-for="l in tgRecommendation.lifestyle" :key="l">{{ l }}</li>
            </ul>
          </template>
          <template v-else>
        ...
        <details class="statin-ref">
          <summary class="statin-ref-summary">📊 Statin 強度分類對照表</summary>
