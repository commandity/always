...
.tab-strip-card:hover {
  border-color: var(--vp-c-brand-1);
}
.tab-strip-card.tab-active {
  box-shadow: 0 0 0 3px rgba(139, 92, 246, 0.18);
  border-color: #8b5cf6;
}
.tab-strip-card.tab-nd {
  border-color: var(--vp-c-divider);
}
.tab-strip-card.normal {
  border-color: #22c55e;
}
.tab-strip-card.moderate {
  border-color: #f97316;
}
.tab-strip-card.critical {
  border-color: #ef4444;
}
...
.tab-strip-card.normal .tsc-val {
  color: #22c55e;
}
.tab-strip-card.moderate .tsc-val {
  color: #f97316;
}
.tab-strip-card.critical .tsc-val {
  color: #ef4444;
}
.tsc-sub {
  font-size: 0.62rem;
...
.btn-yn-no.yn-no-active,
.btn-yn-fail.yn-fail-active {
  border-color: #ef4444;
  background: linear-gradient(
    180deg,
    rgba(239, 68, 68, 0.12),
