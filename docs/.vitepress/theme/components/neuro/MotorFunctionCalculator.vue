...
const activeTab = ref<"updrs">("updrs");

// ══════════════ UPDRS 巴金森評估（Unified Parkinson's Rating）══════════════
...
<template>
  <div class="motorfn">
    ...
    <div class="tab-bar">
      <button
        class="tab-btn"
        :class="{ active: activeTab === 'updrs' }"
        @click="activeTab = 'updrs'"
      >
        <span class="tab-label">UPDRS 巴金森評估</span>
        <span class="tab-sub">Unified Parkinson's Rating</span>
      </button>
    </div>

  <div v-show="activeTab === 'updrs'" class="updrs">
    <!-- ── Header ─────────────────────────────────────────────── -->
...
.updrs .severity-ticks-abs,
.updrs .severity-labels-abs {
  position: relative;
  height: 14px;
  margin-top: 2px;
}
...
.updrs .tick-abs[style*="left: 0%"] {
  transform: translateX(0);
}
.updrs .tick-abs[style*="left: 100%"] {
...
.updrs .label-abs[style*="left: 0%"] {
  transform: translateX(0);
}
.updrs .label-abs[style*="left: 100%"] {
  transform: translateX(-100%);
}
.updrs .lbl-low {
  color: #22c55e;
...
.updrs .mental-pill.group-score-pill {
  border-color: rgba(139, 92, 246, 0.25);
  color: #8b5cf6;
  background: rgba(139, 92, 246, 0.06);
}
.updrs .daily-pill.group-score-pill {
  border-color: rgba(245, 158, 11, 0.25);
  color: #f59e0b;
  background: rgba(245, 158, 11, 0.06);
}
.updrs .motor-pill.group-score-pill {
  border-color: rgba(59, 130, 246, 0.25);
  color: #3b82f6;
  background: rgba(59, 130, 246, 0.06);
}
.updrs .compla-pill.group-score-pill {
  border-color: rgba(239, 68, 68, 0.25);
  color: #ef4444;
  background: rgba(239, 68, 68, 0.06);
}
.updrs .complb-pill.group-score-pill {
...
.updrs .updrs-item:hover {
  box-shadow: 0 3px 12px rgba(0, 0, 0, 0.06);
  border-color: var(--vp-c-divider);
}
.updrs .updrs-item.answered {
...
.updrs .item-score.zero {
  color: #22c55e;
  border-color: rgba(34, 197, 94, 0.25);
  background: rgba(34, 197, 94, 0.06);
}
.updrs .item-score.high {
  color: #ef4444;
  border-color: rgba(239, 68, 68, 0.3);
  background: rgba(239, 68, 68, 0.08);
}
.updrs /* ── Option row — dynamic columns ──────────────────────────────── */
.option-row {
  display: grid;
  gap: 2px;
  padding: 3px;
...
.updrs .opt-pill:hover {
  border-color: var(--vp-c-divider);
  background: var(--vp-c-bg-soft);
}
.updrs .opt-pill input[type="radio"] {
  display: none;
}
.updrs .opt-num {
  font-size: 0.9rem;
...
.updrs /* Score-specific colors — s0 through s4 */
.opt-pill.s0 {
  border-color: rgba(34, 197, 94, 0.15);
}
.updrs .opt-pill.s0:hover:not(.active),
.updrs .opt-pill.s0:focus-within {
  border-color: rgba(34, 197, 94, 0.35);
  background: rgba(34, 197, 94, 0.04);
}
.updrs .opt-pill.s0.active {
  border-color: #22c55e;
...
.updrs .opt-pill.s1:hover:not(.active),
.updrs .opt-pill.s1:focus-within {
  border-color: rgba(132, 204, 22, 0.35);
  background: rgba(132, 204, 22, 0.04);
}
.updrs .opt-pill.s1.active {
  border-color: #84cc16;
...
.updrs .opt-pill.s2:hover:not(.active),
.updrs .opt-pill.s2:focus-within {
  border-color: rgba(234, 179, 8, 0.35);
  background: rgba(234, 179, 8, 0.04);
}
.updrs .opt-pill.s2.active {
  border-color: #eab308;
...
.updrs .opt-pill.s3:hover:not(.active),
.updrs .opt-pill.s3:focus-within {
  border-color: rgba(245, 158, 11, 0.35);
  background: rgba(245, 158, 11, 0.04);
}
.updrs .opt-pill.s3.active {
  border-color: #f59e0b;
...
.updrs .opt-pill.s4:hover:not(.active),
.updrs .opt-pill.s4:focus-within {
  border-color: rgba(239, 68, 68, 0.35);
  background: rgba(239, 68, 68, 0.04);
}
.updrs .opt-pill.s4.active {
  border-color: #ef4444;
  background: color-mix(in srgb, rgb(239, 68, 68) 18%, var(--vp-c-bg));
  box-shadow: 0 0 0 1px rgba(239, 68, 68, 0.08);
}
.updrs .opt-pill.s0 .opt-num {
  color: rgba(34, 197, 94, 0.85);
}
.updrs .opt-pill.s0.active .opt-num {
  color: #22c55e;
}
.updrs .opt-pill.s0 .opt-desc {
  color: rgba(34, 197, 94, 0.7);
}
.updrs .opt-pill.s0.active .opt-desc {
  color: rgba(34, 197, 94, 0.9);
}
.updrs .opt-pill.s1 .opt-num {
  color: rgba(132, 204, 22, 0.85);
}
.updrs .opt-pill.s1.active .opt-num {
  color: #84cc16;
}
.updrs .opt-pill.s1 .opt-desc {
  color: rgba(132, 204, 22, 0.7);
}
.updrs .opt-pill.s1.active .opt-desc {
  color: rgba(132, 204, 22, 0.9);
}
.updrs .opt-pill.s2 .opt-num {
  color: rgba(234, 179, 8, 0.85);
}
.updrs .opt-pill.s2.active .opt-num {
  color: #eab308;
}
.updrs .opt-pill.s2 .opt-desc {
  color: rgba(234, 179, 8, 0.7);
}
.updrs .opt-pill.s2.active .opt-desc {
  color: rgba(234, 179, 8, 0.9);
}
.updrs .opt-pill.s3 .opt-num {
  color: rgba(245, 158, 11, 0.85);
}
.updrs .opt-pill.s3.active .opt-num {
  color: #f59e0b;
}
.updrs .opt-pill.s3 .opt-desc {
  color: rgba(245, 158, 11, 0.7);
}
.updrs .opt-pill.s3.active .opt-desc {
  color: rgba(245, 158, 11, 0.9);
}
.updrs .opt-pill.s4 .opt-num {
  color: rgba(239, 68, 68, 0.85);
}
.updrs .opt-pill.s4.active .opt-num {
  color: #ef4444;
}
.updrs .opt-pill.s4 .opt-desc {
  color: rgba(239, 68, 68, 0.7);
}
.updrs .opt-pill.s4.active .opt-desc {
...
.updrs .res-normal .result-number {
  color: #22c55e;
}
.updrs .res-mild .result-number {
  color: #84cc16;
}
.updrs .res-moderate .result-number {
  color: #f59e0b;
}
.updrs .res-severe .result-number {
  color: #f97316;
}
.updrs .res-critical .result-number {
  color: #ef4444;
}
.updrs .result-max {
  font-size: 1rem;
...
.updrs .result-breakdown {
  display: flex;
  gap: 6px;
  flex-wrap: wrap;
}
.updrs .breakdown-pill {
  font-size: 0.72rem;
  font-weight: 700;
  padding: 2px 10px;
  border-radius: 999px;
}
.updrs .mental-pill-sm {
...
.updrs .compla-pill-sm {
  background: rgba(239, 68, 68, 0.1);
  color: #ef4444;
  border: 1px solid rgba(239, 68, 68, 0.3);
}
.updrs .complb-pill-sm {
  background: rgba(249, 115, 22, 0.1);
  color: #f97316;
  border: 1px solid rgba(249, 115, 22, 0.3);
}
.updrs /* ── Results detail ────────────────────────────────────────────── */
.results-detail {
  border: 1px solid var(--vp-c-divider);
  border-radius: 10px;
  overflow: hidden;
...
.updrs .detail-section-title {
  padding: 0.4rem 0.9rem;
  font-size: 0.75rem;
  font-weight: 700;
  border-bottom: 1px solid var(--vp-c-divider);
}
.updrs .mental-section {
  color: #8b5cf6;
  background: rgba(139, 92, 246, 0.06);
}
.updrs .daily-section {
...
.updrs .compla-section {
  color: #ef4444;
  background: rgba(239, 68, 68, 0.06);
}
.updrs .complb-section {
  color: #f97316;
  background: rgba(249, 115, 22, 0.06);
}
.updrs .detail-row {
...
.updrs .detail-score.zero {
  color: var(--vp-c-text-3);
}
.updrs .detail-score.high {
  color: #ef4444;
}
.updrs .detail-score.brand {
  color: var(--vp-c-brand-1);
}
.updrs .detail-desc {
  font-size: 0.75rem;
...
.updrs .btn-view:hover {
  transform: translateY(-1px);
  box-shadow: 0 4px 14px rgba(99, 102, 241, 0.4);
}
.updrs .btn-view:active {
...
.updrs .opt-pill:nth-child(3) {
    border-right: none;
  }
.updrs .opt-pill:nth-child(3) ~ .opt-pill {
