...
<div style="max-width:700px;margin:1.6rem auto;">
  <div style="border:1.5px solid var(--vp-c-brand-1);border-radius:14px;padding:0.9rem;">
    <div style="text-align:center;font-size:0.72rem;font-weight:800;letter-spacing:0.08em;color:var(--vp-c-brand-1);margin-bottom:0.55rem;">第一階段 · Metformin ＋ 共病導向</div>
    <div style="display:flex;justify-content:center;"><span style="display:inline-block;padding:0.45rem 1.5rem;border-radius:999px;background:var(--vp-c-brand-1);color:#fff;font-weight:700;letter-spacing:0.02em;">T2DM 確診</span></div>
  ...
  <div style="border:1.5px solid #f59e0b;border-radius:14px;padding:0.9rem;">
