---
layout: doc
title: 口服降血糖藥（OHA）完整比較與選擇指引 — Oral Hypoglycemic Agents (OHA) — Comprehensive Comparison & Selection Guide
---
...
## 核心治療架構 Core Treatment Framework
...
<div style="max-width:700px;margin:1.6rem auto;">
  <div style="border:1.5px dashed #6366f1;border-radius:14px;padding:0.9rem 0.85rem;background:rgba(99,102,241,0.05);">
    <div style="text-align:center;font-size:0.72rem;font-weight:800;letter-spacing:0.08em;color:#4f46e5;margin-bottom:0.55rem;">第一階段 · Metformin ＋ 共病導向</div>
    <div style="display:flex;justify-content:center;"><span style="display:inline-block;padding:0.45rem 1.5rem;border-radius:999px;background:#6366f1;color:#fff;font-weight:700;letter-spacing:0.02em;">T2DM 確診</span></div>
  <div style="text-align:center;color:var(--vp-c-text-3);font-size:1.15rem;line-height:1;margin:0.22rem 0;">↓</div>
  ...
  <div style="text-align:center;color:var(--vp-c-text-3);font-size:0.8rem;margin:0.55rem 0;">Metformin 後，依共病 → 肥胖 → 年齡 逐步加藥</div>
  <div style="display:flex;border:1px solid var(--vp-c-divider);border-left:4px solid #6366f1;border-radius:8px;overflow:hidden;background:var(--vp-c-bg-soft);">
  ...
  <div style="text-align:center;font-size:0.85rem;margin:0.65rem 0;"><span style="display:inline-block;padding:0 0.45rem;border-radius:5px;background:rgba(239,68,68,0.12);color:#dc2626;font-weight:700;font-size:0.78rem;">否</span> <span style="color:var(--vp-c-text-3);">↓ 續評估</span></div>
  <div style="display:flex;border:1px solid var(--vp-c-divider);border-left:4px solid #6366f1;border-radius:8px;overflow:hidden;background:var(--vp-c-bg-soft);">
  ...
  <div style="text-align:center;font-size:0.9rem;margin:0.55rem 0;"><span style="display:inline-block;padding:0 0.45rem;border-radius:5px;background:rgba(239,68,68,0.12);color:#dc2626;font-weight:700;font-size:0.78rem;">否</span> <span style="color:var(--vp-c-text-3);">↓ 進入 A1C 評估</span></div>
  <div style="border:1.5px dashed #f59e0b;border-radius:14px;padding:0.9rem 0.85rem;background:rgba(245,158,11,0.05);">
    <div style="text-align:center;font-size:0.72rem;font-weight:800;letter-spacing:0.08em;color:#b45309;margin-bottom:0.55rem;">第二階段 · A1C 缺口評估</div>
    <div style="display:flex;justify-content:center;"><span style="display:inline-block;padding:0.42rem 1.3rem;border-radius:999px;background:#f59e0b;color:#fff;font-weight:700;">A1C 缺口評估 Assess A1C gap</span></div>
  <div style="text-align:center;color:var(--vp-c-text-3);font-size:1.15rem;line-height:1;margin:0.22rem 0;">↓</div>
...
## 共病導向之首選藥物 Comorbidity-Driven First-Line Agents
...
## 各類藥物副作用與病人考量 Adverse Effects & Patient Considerations by Class
...
## 各類藥物完整比較 Comprehensive Comparison by Class
...
### 9. 各類別臨床定位總表 Clinical Positioning Summary by Class
...
## 重要交互作用與實務提醒 Key Interactions & Practical Reminders
