...
<svg width="100%" viewBox="0 0 700 460" xmlns="http://www.w3.org/2000/svg" role="img" style="font-family:sans-serif; margin-top: 1rem; border-radius: 12px; border: 1px solid var(--vp-c-divider); overflow: hidden;">
<title>糖尿病腎病變自然病程 — eGFR 與 UACR 隨病程變化</title>
<rect x="0" y="0" width="700" height="460" fill="#FFFEF5"/>
...
<svg width="100%" viewBox="0 0 680 510" xmlns="http://www.w3.org/2000/svg" role="img" style="font-family:sans-serif; margin-top: 1rem; border-radius: 12px; border: 1px solid var(--vp-c-divider); overflow: hidden;">
<title>CKD 風險分層矩陣 — eGFR × uACR（含 SGLT2i 給付適應症標記）</title>
<rect x="0" y="0" width="680" height="510" fill="#FFFEF5"/>
