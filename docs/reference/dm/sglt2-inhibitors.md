...
<svg width="100%" viewBox="0 0 700 460" xmlns="http://www.w3.org/2000/svg" role="img" style="font-family:sans-serif; margin-top: 1rem;">
<title>糖尿病腎病變自然病程 — eGFR 與 UACR 隨病程變化</title>
<rect x="0" y="0" width="700" height="460" rx="8" fill="#FFFEF5"/>
