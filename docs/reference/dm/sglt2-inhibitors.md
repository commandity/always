...
<svg width="100%" viewBox="-16 -16 732 492" xmlns="http://www.w3.org/2000/svg" role="img" style="font-family:sans-serif; margin-top: 1rem; border-radius: 12px; border: 1px solid var(--vp-c-divider); overflow: hidden;">
<title>糖尿病腎病變自然病程 — eGFR 與 UACR 隨病程變化</title>
<rect x="-16" y="-16" width="732" height="492" rx="12" fill="#FFFEF5"/>
...
<svg width="100%" viewBox="-16 -16 712 542" xmlns="http://www.w3.org/2000/svg" role="img" style="font-family:sans-serif; margin-top: 1rem; border-radius: 12px; border: 1px solid var(--vp-c-divider); overflow: hidden;">
<title>CKD 風險分層矩陣 — eGFR × uACR（含 SGLT2i 給付適應症標記）</title>
<rect x="-16" y="-16" width="712" height="542" rx="12" fill="#FFFEF5"/>
...
8. Mogensen CE. Microalbuminuria predicts clinical proteinuria and early mortality in maturity-onset diabetes. _N Engl J Med_. 1984;310(6):356-360.
